...
public class UserServiceImpl implements UserService{
	...
	// SecurityConfig 클래스에 @Bean 설정으로 bean 이 된 PasswordEncoder 객체를 주입 받기
	...
	@Override
	public void updatedUserInfo(UserDto dto) {
		// MultipartFile 객체
		...
		if(!image.isEmpty()) {
			...
			// 이미지 확장자를 유지하기 위해 뒤에 원본 파일명을 추가한다.
	...
	public void changePassword(UserDto dto) {
		...
		// 5. 일치하면 새 비밀번호를 암호화해서 dto 에 담은 담음
