...
public class HomeController {
	...
	public String home(Model model) {
		...
		// 오늘의 인물
		String personToday = "맹구";
		// 응답에 필요한 데이터를 Model 객체에 담는다.
		model.addAttribute("personToday", personToday);
		
		// GET 방식 파라미터 출력 테스트를 위해 필요한 sample 데이터도 Model 에 담기
		 ...
		 * 
		 * /static/ 폴더의 html 페이지는 내용 그대로 응답 되지만
		 * /template/ 폴더의 html 페이지는 view engine(Thymeleaf) 가 해석을 하고 해석된 결과가 응답된다.
		 * 
		 */
