...
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 5, // 메모리 임계값 (메모리에 5메가 차면 넘기겠다 효율적 사용을 위해)
...
public class UploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (filePart != null) {
			...
			/*
			 * 업로드된 파일은 임시 폴더에 임시 파일로 저장이 된다. 해당 파일에서 byte 알갱이를 읽어들일수 있는 InputStream 객체를
			 * 얻어내고
			 */
