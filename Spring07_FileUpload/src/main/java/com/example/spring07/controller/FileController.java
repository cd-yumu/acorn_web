...
public class FileController {
	...
	/*
	 * ResponseEntity<InputStreamResource> 는 파일을 다운로드 할 때 사용하는 return type 이다.
	 */
	...
	public ResponseEntity<InputStreamResource> download(
		...
		try {
			...
			e.printStackTrace();
			// 예외 발생시키기
			throw new RuntimeException("파일 다운로드 하는 중에 에러 발생!");
		}
	}
	...
	public String upload(String title, MultipartFile myFile, Model model) {
		...
		/*
		 * System.out.println("title: " + title); System.out.println("원본 파일명: " +
		 * myFile.getOriginalFilename()); System.out.println("파일의 크기: " +
		 * myFile.getSize());
		 */
