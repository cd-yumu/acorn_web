...
<%
	...
	String content2 = content.replace("\"", "\\\""); // "를 \"로 변경
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<script>
	    ...
	    const editor = new Editor({
	        el: document.querySelector('#editor'),  // 어디에 Editor 를 만들 것인지
	        height: '500px',                        // 높이
	    ...
	    document.querySelector("#updateForm").addEventListener("submit",(e)=>{
        	...
        	// 입력된 내용을 검증: 폼에 이거 말고 다른 내용도 입력했다면 검증을 여기서 하고
        	
        	// 폼 전송을 막고 싶으면 event.preventDefault(); 가 실행되게 하면 된다.
        });  
	</script>
</body>
</html>