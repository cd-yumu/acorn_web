...
@Configuration		// 설정용 클래스라고 알려줌
@EnableWebSecurity	// Security 를 설정하기 위한 어노테이
public class SecurityConfig {
	 ...
	 *  또한 SecurityFilterChain 객체도 스프링이 관2리하는 Bean 이 되어야 한다 
	 */
