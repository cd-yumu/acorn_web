...
import com.example.spring01.serveice.HomeService;
import com.example.spring01.serveice.HomeServiceImpl;
...
public class Spring01HelloApplication {
	...
	// 이 클래스로 객체가 '생성된 이후에 호출'하고 싶은 메소드에 @PostConstruct 메소드를 붙여 놓으면 된다.
	@PostConstruct
	public void exec() {
